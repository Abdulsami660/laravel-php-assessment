    ...
    <nav id="header-nav" class="navbar navbar-expand-lg px-3 mb-3">
      <div class="container-fluid">
        <a class="navbar-brand" href="/">
          <img src="/public/front-end-resources/images/main-logo.png" class="logo">
        </a>
        ...
        <div class="offcanvas offcanvas-end" tabindex="-1" id="bdNavbar" aria-labelledby="bdNavbarOffcanvasLabel">
          ...
          <div class="offcanvas-body">
            <ul id="navbar" class="navbar-nav text-uppercase justify-content-end align-items-center flex-grow-1 pe-3">
              <li class="nav-item">
                <router-link class="nav-link me-4 active" to="/">Home</router-link>
              </li>
              <li class="nav-item">
                <a class="nav-link me-4 " href="/admin/products">Products</a>
                <!-- <router-link class="nav-link me-4" to="/admin/products">Products</router-link> -->
              </li>
            ...
            <div class="row d-flex align-items-center">
              <div class="col-md-6">
                <div class="banner-content">
                  ...
                  <a href="/admin/products" class="btn btn-medium btn-dark text-uppercase btn-rounded-none">Explore
                    Products</a>
                </div>
              </div>
              <div class="col-md-5">
                <div class="image-holder">
                  <img src="/public/front-end-resources/images/banner-image.png" alt="banner">
                </div>
              </div>
            </div>
          </div>
